...
# Find route
data_type = 'binary' # or 'greyscale'
if data_type == 'binary':
    data_dir = "../data/final_binary_data/"
elif data_type == 'greyscale':
...
# NUM_OF_COMP = 16 # TURN IT ON TO OBTAIN 16 PCs
...
if NUM_OF_COMP == 12:
    back.to_csv('finalfinal_80_'+data_type+'.csv')
elif NUM_OF_COMP == 16:
    back.to_csv('finalfinal_90_'+data_type+'.csv')
print(back)
...
if NUM_OF_COMP == 12:
    back.to_csv('difference_80_'+data_type+'.csv')
elif NUM_OF_COMP == 16:
    back.to_csv('difference_90_'+data_type+'.csv')
print(diff)
